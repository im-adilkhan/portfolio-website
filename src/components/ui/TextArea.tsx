  ...
  return (
    <div className="group">
      ...
      <textarea
        ...
        rows={5}
        className={cn(
          "w-full resize-none rounded-lg border border-line bg-surface/50 px-4 py-3 text-base text-fg outline-none sm:text-sm transition-all duration-300 placeholder:text-muted/50",
